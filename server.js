/**
 * server.js - バックエンドサーバー (Gemini API 連携版)
 * 
 * 主な変更点:
 * 1. Anthropic SDK を Google Generative AI SDK (@google/generative-ai) に変更
 * 2. 環境変数名を GEMINI_API_KEY に変更
 * 3. ストリーミング処理を Gemini の形式に合わせる
 */
