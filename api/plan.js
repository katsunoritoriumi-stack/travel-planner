...
function buildSystemInstruction(budgetStyle, tasks, transport) {
    const transportInstructions = {
        ...
        mycar: "主な移動手段はマイカー（自家用車）を前提にしてください。以下を必ず記載してください：\n- 出発地から目的地までの高速道路料金目安（ETC料金と通常料金）\n- 走行距離と燃料費の目安（一般的な燃費15km/Lで計算）\n- 駐車場情報と1日あたりの駐車料金目安\n- 高速道路のおすすめルートとSA・PA情報\n- 合計ドライブ費用（高速代＋燃料費＋駐車場代）の見積もり",
